...
export default defineComponent({
  ...
  props: {
     ...
     * @en Button types are diveded into five types: secondary, primary, dashed, outline and text.
    ...
    /**
     * @zh 按钮的宽度是否随容器自适应
     * @en Whether the width of the bbutton adapts to the container.
     */
    long: {
      type: Boolean,
      default: false,
